...
```{r load_data}
# Load the LiDAR data
Unipark <- readLAS("DATA/PUNKTSKY_1km_6225_574_unipark.laz")
```
...
*No, because this is meters above sea level. We need the normalized point cloud.*
---
...
*The vegetation is represented by greenish colors and buildings are represented by darkgrey.*
